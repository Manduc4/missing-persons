...
export const fetchPersons = createAsyncThunk<
  PersonsResponseProps,
  PersonsPayloadProps
>('persons.fetchPersons', async (data, { rejectWithValue }) => {
  try {
...
export const fetchPerson = createAsyncThunk<
  PersonResponseProps,
  PersonPayloadProps
>('persons.fetchPerson', async (data, { rejectWithValue }) => {
  try {
    const api = axiosInstance;
...
export const updatePersonOccurence = createAsyncThunk<
...
export const fetchPersonOccurence = createAsyncThunk<
  UpdatePersonOccurenceResponseProps,
  PersonOccurencePayloadProps
>('persons.fetchPersonOccurence', async (data, { rejectWithValue }) => {
  try {
    const api = axiosInstance;
    const searchParams = new URLSearchParams();
